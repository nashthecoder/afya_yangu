...
const injectCode = (root, PHP, injectBodyOptions) => {
    return async (req, res, next) => {
        if (req.url &&
            (req.url === '/' || (0, path_1.extname)(req.url) === '.html' || (0, path_1.extname)(req.url) === '.htm' || (0, path_1.extname)(req.url) === '.php')) {
            let filePath = (0, path_1.resolve)((0, path_1.join)(root + req.url));
            ...
            if ((0, path_1.extname)(req.url) === '.php') {
