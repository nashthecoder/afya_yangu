declare const explorer: {
    ...
    html(req: any, res: any, files: any, next: any, dir: any, showUp: any, icons: any, path: any, view: any, template: any, stylesheet: any): void;
...
export declare function htmlPath(dir: any): string;
