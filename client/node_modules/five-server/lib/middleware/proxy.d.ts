...
export declare const proxyMiddleware: (options: ProxyMiddlewareOptions, injectBody: boolean) => (req: RequestWithRetry, res: Response, next: NextFunction) => Promise<void>;
export {};
